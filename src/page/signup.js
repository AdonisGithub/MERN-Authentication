...
const Signup = () => {
  return (
	<div className="h-screen lg:flex">
		<div className="relative overflow-hidden lg:flex hidden w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 justify-around items-center">
			<div>
				<h1 className="text-white font-bold text-4xl font-sans">MERN Stack</h1>
				<p className="text-white mt-1">The most popular web developing framework</p>
				<button type="submit" className="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2">Read More</button>
			</div>
		</div>
		<div className="flex lg:w-1/2 justify-center py-24 items-center bg-white">
			<form className="bg-white">
				...
				<a href= "/forgotpassword" className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Forgot Password ?</a>
			</form>
		</div>
	</div>
  );
