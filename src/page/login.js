    ...
    <div className="h-screen lg:flex">
      <div className="lg:flex hidden w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 justify-around items-center">
        <div>
          ...
          <p className="text-white mt-1">The most popular framework for developing website</p>
          <button type="submit" className="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2">Read More</button>
        </div>
      </div>
      <div className="flex w-1/2 justify-center mx-auto py-36 items-center bg-white">
